...
<head>
  ...
  <title>Ekantomart One Time Password {{$name}}</title>
  <style>
    /* -------------------------------------
          GLOBAL RESETS
      ------------------------------------- */
                ...
                <table border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td>
                      ...
                      <table border="0" cellpadding="0" cellspacing="0" class="btn btn-pm">
                        <tbody>
                          <tr>
                            <td align="left">
                              <table border="0" cellpadding="0" cellspacing="0">
                                <tbody>
                                  <tr>
                                        ...
                                        <p><b>Your email verification OTP is:
                                        </b></p>
                        
                                        <h3>{{$verification_code}}</h3>
                                    </tr>
                                </tbody>
                               <b> Please note this code is only valid for 4 minutes.</b>
                              </table>
                            </td>
                          </tr>
                        </tbody>
