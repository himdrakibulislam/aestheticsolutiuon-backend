   ...
   <div class="content">
    <div class="card">
      <div class="card-header">
          <h6 class="d-inline">Edit project</h6>
      ...
      <div class="card-body">
        ...
        <form action="{{url('admin/project/update/'.$project->id)}}" enctype="multipart/form-data" method="POST">
          @csrf
          @method('PUT')
              ...
              @enderror
               ...
               <div class="mb-3 col-md-6 ">
                ...
                <select name="sector" class="form-control" id="" required>
                  ...
                  <option value="Commercial" @if ($project->sector === "Commercial")
                      @selected(true)
                  @endif>Commercial </option>
                  <option value="Residential"  @if ($project->sector === "Residential")
                    @selected(true)
         ...
         {{-- seo section --}}
          <div class="tab-pane border p-3 fade" id="seo-tags" role="tabpanel" aria-labelledby="seo-tags-tab">
               ...
               <div class="mb-3">
                 ...
                 <fieldset>
                  <input name='meta_keyword' placeholder='Keyword' value="{{$project->meta_keyword}}">
                </fieldset>
                @error('meta_keyword')
                    <div class="alert alert-danger">
                      {{ $message }}
