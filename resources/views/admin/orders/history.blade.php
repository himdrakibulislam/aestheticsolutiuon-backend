    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
              ...
              <a href="{{url('admin/orders')}}" class="btn btn-secondary btn-sm float-right "><i class="fas fa-cart-plus"></i>Orders </a>
            </div>
            <!-- /.card-header -->
            @if (!$orders->count() <= 0 )
                 ...
                 <tr>
                  ...
                  <td>
                   @if ($row->order_status === 2 )
                       <span class="text-secondary border p-1 bg-success badge">Delivered</span>
                   @endif
                  </td>
